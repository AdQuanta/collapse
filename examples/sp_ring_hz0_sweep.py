...
Usage::
    ...
    python examples/sp_ring_hz0_sweep.py -N 9 --save figures/hz0_sweep
    python examples/sp_ring_hz0_sweep.py -N 7 9 11 --workers 4 --save figures/hz0_sweep
    python examples/sp_ring_hz0_sweep.py -N 9 --hz 1.0 --Jx 0.1 --save figures/hz0_sweep
"""
