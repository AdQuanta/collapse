...
Usage::
    ...
    python examples/full_hamiltonian_scan.py
    python examples/full_hamiltonian_scan.py -N 5 --workers 1
    python examples/full_hamiltonian_scan.py --save figures/scan
    python examples/full_hamiltonian_scan.py --no-theta
"""
