"""
Single-Pixel Ring – Single-parameter Born-distribution diagnostic
==================================================================
...
Usage::
    ...
    python examples/sp_ring_single_born.py -N 7 9 11 --save figures/single_born
"""
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "SP ring – single parameter set, Born diagnostic.  "
    ...
    log_file = log_dir / f"sp_ring_single_born_{datetime.now():%Y%m%d_%H%M%S}.log"
    ...
    logger.info(
        f"=== SP Ring single-param Born diagnostic: "
