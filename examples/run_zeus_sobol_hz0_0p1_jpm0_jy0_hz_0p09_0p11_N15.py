...
"""Run one 25-case batch with hz in [0.09,0.11], hz0=0.1, Jpm=Jy=0, and N=15."""
...
def _copy_provenance_once(campaign: SobolCampaign) -> None:
    ...
    try:
        ...
        for relative in (
            "examples/run_zeus_sobol_hz0_0p1_jpm0_jy0_hz_0p09_0p11_N15.py",
            "hpc/zeus_sobol_hz0_0p1_jpm0_jy0_hz_0p09_0p11_N15_array.pbs",
            "hpc/submit_zeus_sobol_hz0_0p1_jpm0_jy0_hz_0p09_0p11_N15.sh",
            "hpc/zeus_sobol_hz0_0p1_jpm0_jy0_hz_0p09_0p11_N15.md",
        ):
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError("production invariants changed: require hz in [0.09,0.11], hz0=0.1, Jpm=Jy=0, count=100, N=15")
