...
Usage::
    ...
    python examples/sp_ring_hx_sweep_field_placement.py
    python examples/sp_ring_hx_sweep_field_placement.py -N 7 --workers 4
    python examples/sp_ring_hx_sweep_field_placement.py --save figures/hx_field --bloch
"""
