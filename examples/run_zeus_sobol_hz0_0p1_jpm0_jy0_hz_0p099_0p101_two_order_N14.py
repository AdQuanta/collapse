...
from examples.run_zeus_sobol_hz0_0p1_jpm0_jy0_hz_0p099_0p101_N15 import (  # noqa: E402
    BATCH_SIZE,
    FAMILY,
    FIXED_JPM,
    FIXED_JY,
...
def _copy_provenance_once(campaign: SobolCampaign) -> None:
    ...
    try:
        ...
        for relative in (
            "examples/run_zeus_sobol_hz0_0p1_jpm0_jy0_hz_0p099_0p101_two_order_N14.py",
