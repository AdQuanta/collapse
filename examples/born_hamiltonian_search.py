...
Example:
    ...
    python examples/born_hamiltonian_search.py --N 10 --top 12
"""
...
from collapse.disorder import create_disorder_strategy
...
def write_diagnostic_index(path: Path, plotted: list[dict[str, Any]], include_spectra: bool = True) -> None:
    ...
    lines = [
        ...
        "",
        "Each figure is generated by `examples/born_hamiltonian_search.py` during the simulation run.",
        panel_text,
        "",
