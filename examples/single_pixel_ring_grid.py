...
Usage::
    ...
    python examples/single_pixel_ring_grid.py
    python examples/single_pixel_ring_grid.py -N 7 --workers 4
    python examples/single_pixel_ring_grid.py --save figures/sp_ring
    python examples/single_pixel_ring_grid.py --save figures/sp_ring --bloch
"""
