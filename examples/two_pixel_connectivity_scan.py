...
:class:`~collapse.analysis.DisentanglementAnalyzer`, and plots the
combined θ-histogram + ratio figure.

Usage::

    python examples/two_pixel_connectivity_scan.py
    python examples/two_pixel_connectivity_scan.py --no-theta
    python examples/two_pixel_connectivity_scan.py --save tp_conn.png
    python examples/two_pixel_connectivity_scan.py -N 9
"""
