...
Usage::
    ...
    python examples/sp_ring_analytical_ptheta.py --save figures/analytical
    python examples/sp_ring_analytical_ptheta.py -N 5 7 --save figures/analytical
"""
...
from collapse.pauli import build_pauli_operators
