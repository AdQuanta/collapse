...
Usage::
    ...
    python examples/haar_random_unitary.py
    python examples/haar_random_unitary.py -N 7 --bloch
    python examples/haar_random_unitary.py -N 7 --save figures/haar
    python examples/haar_random_unitary.py -N 7 --seed 42
"""
