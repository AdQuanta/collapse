...
Usage::
    ...
    python examples/spherical_harmonics_demo.py
    python examples/spherical_harmonics_demo.py -N 9 -t 15 --l-max 8
    python examples/spherical_harmonics_demo.py --save figures/sh_demo
"""
