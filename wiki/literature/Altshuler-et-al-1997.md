...
Altshuler et al.'s Fock-space graph framework provides the exact physical picture for why a many-body detector does not immediately thermalize upon coupling to a qubit. If the detector operates near a Fock-space localization boundary, excitations remain structured and coherent rather than dissipating into ergodic thermal noise, allowing the matrix pencil $(A_N, C_N)$ to produce stable, unentangled projective roots.
