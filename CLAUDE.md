...
- Zeus HPC: `.claude/skills/zeus-hpc/SKILL.md`.
- Scientific writing: `.claude/skills/high-impact-academic-scientific-writing/SKILL.md`.
- Karpathy LLM wiki: `.claude/skills/karpathy-llm-wiki/SKILL.md`.
- Zotero: `.claude/skills/zotero-use/SKILL.md`.
