...
RUN_ROOT="${RUN_ROOT:-$REPO_ROOT/work/zeus_sobol_hz0_0p1_hz_0p0999_0p1001_two_order_N14_$(date +%Y%m%d_%H%M%S)}"
case "$RUN_ROOT" in
  /*) ;;
...
PBS_SCRIPT="$REPO_ROOT/hpc/zeus_sobol_hz0_0p1_jpm0_jy0_hz_0p0999_0p1001_two_order_N14_array.pbs"
JOB_ID="$(qsub -v "RUN_ROOT=$RUN_ROOT" "$PBS_SCRIPT")"
printf '%s job_id=%s array=0-3 N=14 hz0=0.1 hz=[0.0999,0.1001] Jpm=0 Jy=0 kappa=0.01 total=100 shard_size=25 run_root=%s\n' \
