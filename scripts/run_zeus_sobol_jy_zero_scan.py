...
"""Run Simulation A: 100 Sobol points in (Jx,J,Jpm,hz) with Jy=0."""
...
from core.sobol_coupling_scan import SobolCampaign, build_settings  # noqa: E402
...
def main() -> None:
    ...
    settings = build_settings(
        "jy_zero", seed=args.seed, count=args.count, sizes=tuple(args.sizes),
    ...
    print(f"Simulation A {'dry-run prepared' if args.dry_run else 'finished'}: {root.resolve()}")
