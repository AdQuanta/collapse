...
Usage::
    ...
    python scripts/central_spin_grid.py
    python scripts/central_spin_grid.py -N 7 --workers 4
    python scripts/central_spin_grid.py --save figures/cs_grid
    python scripts/central_spin_grid.py --save figures/cs_grid --bloch
"""
...
from core.hamiltonians.quspin_hamiltonians import CentralSpinHamiltonianQuSpin
