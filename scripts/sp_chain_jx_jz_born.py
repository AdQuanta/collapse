...
Usage::
    ...
    python scripts/sp_chain_jx_jz_born.py -N 9 --workers 4 --save figures/born_chain
    python scripts/sp_chain_jx_jz_born.py -N 7 9 --save figures/born_chain
    python scripts/sp_chain_jx_jz_born.py -N 9 --save figures/born_chain --hz-idx 3
"""
