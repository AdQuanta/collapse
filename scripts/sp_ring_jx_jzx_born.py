...
Usage::
    ...
    python scripts/sp_ring_jx_jzx_born.py -N 9 --workers 4 --save figures/born_jx_jzx
    python scripts/sp_ring_jx_jzx_born.py -N 7 9 11 --save figures/born_jx_jzx
    python scripts/sp_ring_jx_jzx_born.py -N 9 --save figures/born_jx_jzx --jzx-idx 3
"""
