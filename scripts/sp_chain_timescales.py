...
Usage::
    ...
    python scripts/sp_chain_timescales.py --save figures/chain_timescales
    python scripts/sp_chain_timescales.py -N 7 --Jpm 1 --Jx 0.05 --hz 0.5 --save figures/chain_timescales
"""
