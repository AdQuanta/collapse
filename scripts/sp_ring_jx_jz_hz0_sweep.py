...
Usage::
    ...
    python scripts/sp_ring_jx_jz_hz0_sweep.py -N 7 --workers 4 --save figures/sweep3d_hz0
    python scripts/sp_ring_jx_jz_hz0_sweep.py -N 7 --workers 4 --save figures/sweep3d_hz0 --hz0-idx 3
"""
