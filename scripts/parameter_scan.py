...
Usage::
    ...
    python scripts/parameter_scan.py                # θ-space (default)
    python scripts/parameter_scan.py --no-theta      # z-space
    python scripts/parameter_scan.py --save scan.png # save figure
"""
