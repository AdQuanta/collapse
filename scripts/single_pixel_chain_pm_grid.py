...
Usage::
    ...
    python scripts/single_pixel_chain_pm_grid.py
    python scripts/single_pixel_chain_pm_grid.py -N 7 --workers 4
    python scripts/single_pixel_chain_pm_grid.py --save figures/sp_chain_pm
    python scripts/single_pixel_chain_pm_grid.py --save figures/sp_chain_pm --bloch
"""
