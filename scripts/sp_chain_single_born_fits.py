...
Usage::
    ...
    python scripts/sp_chain_single_born_fits.py -N 7 9 --save figures/fits_chain
    python scripts/sp_chain_single_born_fits.py -N 9 --Jx 0.1 --Jz 0.5 --hz 1.0 --save figures/fits_chain
"""
