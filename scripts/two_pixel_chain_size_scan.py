...
Usage::
    ...
    python scripts/two_pixel_chain_size_scan.py
    python scripts/two_pixel_chain_size_scan.py --no-theta
    python scripts/two_pixel_chain_size_scan.py --save tp_scan.png
"""
