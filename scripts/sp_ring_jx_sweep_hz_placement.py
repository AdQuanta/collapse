...
Usage::
    ...
    python scripts/sp_ring_jx_sweep_hz_placement.py
    python scripts/sp_ring_jx_sweep_hz_placement.py -N 7 --workers 4
    python scripts/sp_ring_jx_sweep_hz_placement.py --save figures/jx_hz --bloch
"""
