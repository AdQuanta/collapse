...
Usage::
    ...
    python scripts/sp_ring_jx_hz_born.py -N 9 --workers 4 --save figures/born
    python scripts/sp_ring_jx_hz_born.py -N 7 9 11 --save figures/born
    python scripts/sp_ring_jx_hz_born.py -N 9 --save figures/born --hz-idx 3
"""
