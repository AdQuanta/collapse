...
Usage::
    ...
    python scripts/sp_ring_hz_sweep_placement.py
    python scripts/sp_ring_hz_sweep_placement.py -N 7 --workers 4
    python scripts/sp_ring_hz_sweep_placement.py --save figures/hz_sweep --bloch
"""
