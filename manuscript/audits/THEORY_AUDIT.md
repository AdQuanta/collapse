...
`core/analysis.py` and `core/relative_evolution_pencil.py` use `U00=A` and `U10=C` and solve
...
- `core/analysis.py:29-104`, `262-427`;
- `core/born.py:83-145`, `195ff`;
- `core/relative_evolution_pencil.py:1-183`;
- `tests/test_relative_evolution_pencil.py`;
- `scripts/haar_random_unitary.py`;
...
- Production relative-evolution definition and antipodal construction: `core/analysis.py`.
- Born/reflection and azimuthal diagnostics: `core/born.py`.
- Homogeneous QZ implementation: `core/relative_evolution_pencil.py`.
- Projective unit tests: `tests/test_relative_evolution_pencil.py`.
- Haar numerical driver: `scripts/haar_random_unitary.py`.
- Relative-unitary/weak-coupling analytical bridge: `core/relative_unitary_theory.py` and `tests/test_relative_unitary_theory.py`.
...
The current `manuscript/main.tex` and `manuscript/supplement.tex` were checked against the theorems above and compiled with MiKTeX. Both compile with resolved citations and cross-references to a four-page Letter and a nine-page, single-column Supplement. The following theory-facing corrections were integrated:
