...
| H2 | Stored `N=13`, seed 44 Haar sphere looks isotropic. | **PRE-CUTOFF / UNTRUSTED** | `figures/haar_random_unitary/haar_N13_seed44.png`, last modified 2026-03-12; `scripts/logs/haar_random_20260312_215508.log` documents only an `N=5` run that day, not the N13 file. | One realization; seed 44; raw unitary/roots and N13 log absent; no discrepancy statistic or uncertainty. | **Forbidden** in paper and Supplement under cutoff. Remove the copied version from any draft package. |
...
| O1 | Older logs/notebooks/figures establish model trends. | **PRE-CUTOFF / UNTRUSTED or DATE UNKNOWN / UNTRUSTED** | Root notebooks dated Jan-Feb 2026; `scripts/logs/*` dated Feb-May 2026; `tp_size_scan_*.png` dated March 2026; copied legacy result directories lacking post-cutoff embedded rerun records. | Seeds and parameters vary; many raw products/logs are incomplete. Copied/creation dates around July 11 do not cure older embedded dates. | **Forbidden** as quantitative manuscript evidence. May guide a reproduction only. |
...
- resonance, two-pixel, anisotropic, Sobol, and graph counterscripts/controls;
