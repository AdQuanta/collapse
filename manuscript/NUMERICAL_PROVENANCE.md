...
- **Post-processing generation:** UTC timestamp recorded in `manuscript/figures/figure_manifest.json`.
- **Figure:** `manuscript/figures/full_sphere_matched.pdf` (PNG inspection copy alongside it).
- **Manuscript location:** Main Letter Fig. 3; Supplemental Sec. VII and Table S2.
- **Script:** `manuscript/scripts/build_figures.py`.
...
- **Figure:** `manuscript/figures/matched_field_scaling.pdf`.
...
- **Figure source:** `reports/zeus_single_pixel_analysis_2026-07-16/regime_tradeoffs.png`; copied without scientific modification to `manuscript/figures/regime_tradeoffs.png`.
- **Figure SHA-256:** `b5ef3820462eb178d4dcc9a42b52388357c993f0326bf200805ffa2403beece2`.
- **Manuscript location:** Supplemental Fig. S1.
- **Script:** `scripts/interpret_zeus_single_pixel_scaling.py`.
