...
:mod:`core.pauli` and disorder sampling to
:mod:`core.disorder`, satisfying the Single Responsibility
...
fields) via a :class:`~core.disorder.DisorderStrategy`.
"""
...
from core.disorder import DisorderStrategy, create_disorder_strategy
