...
mirrors its NumPy counterpart in :mod:`core.hamiltonians.numpy_hamiltonians`
...
:class:`~core.hamiltonians.base.HamiltonianGenerator` interface
...
:class:`~core.disorder.DisorderStrategy`.
...
from core.disorder import DisorderStrategy
...
class CentralSpinHamiltonianQuSpin(HamiltonianGenerator):
    ...
    See :class:`~core.hamiltonians.numpy_hamiltonians.CentralSpinHamiltonianNumpy`
...
class MixedFieldIsingHamiltonianQuSpin(HamiltonianGenerator):
    ...
    See :class:`~core.hamiltonians.numpy_hamiltonians.MixedFieldIsingHamiltonianNumpy`
    for parameter documentation.
    """
...
class SinglePixelHamiltonianQuSpin(HamiltonianGenerator):
    ...
    See :class:`~core.hamiltonians.numpy_hamiltonians.SinglePixelHamiltonianNumpy`
    for parameter documentation.
    """
...
class DimerizedPixelHamiltonianQuSpin(HamiltonianGenerator):
    ...
    See :class:`~core.hamiltonians.numpy_hamiltonians.DimerizedPixelHamiltonianNumpy`
    for parameter documentation.
    """
...
class TwoPixelHamiltonianQuSpin(HamiltonianGenerator):
    ...
    See :class:`~core.hamiltonians.numpy_hamiltonians.TwoPixelHamiltonianNumpy`
    for parameter documentation.
    """
