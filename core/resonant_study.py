...
try:  # QuSpin is preferred; its compiled extension is unavailable on some Windows installs.
    from core.hamiltonians.quspin_hamiltonians import SinglePixelHamiltonianQuSpin as _SinglePixelHamiltonian
    ...
    from core.hamiltonians.numpy_hamiltonians import SinglePixelHamiltonianNumpy as _SinglePixelHamiltonian
