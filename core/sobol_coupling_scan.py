...
from core.anisotropic_sweep import BLUE, RED, RATIO, _bloch_branches
...
class SobolCampaign:
    ...
    def _copy_provenance(self) -> None:
        ...
        for source in (
            Path(__file__),
            Path(__file__).resolve().parents[1] / "scripts" / "run_zeus_sobol_jy_zero_scan.py",
            Path(__file__).resolve().parents[1] / "scripts" / "run_zeus_sobol_jy_nonzero_scan.py",
