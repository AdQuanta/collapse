...
STUDIES: dict[str, StudyDefinition] = {
    "hz0": StudyDefinition(
        name="hz0",
        driver="scripts/plot_single_pixel_hz0_diagnostic_atlas.py",
    ...
    "hz_resonance": StudyDefinition(
        name="hz_resonance",
        driver="scripts/plot_single_pixel_hz_resonance_atlas.py",
    ...
    "jpm_hz": StudyDefinition(
        name="jpm_hz",
        driver="scripts/plot_single_pixel_jpm_hz_atlas.py",
    ...
    "jpm_coupling": StudyDefinition(
        name="jpm_coupling",
        driver="scripts/plot_single_pixel_jpm_sweep_atlas.py",
