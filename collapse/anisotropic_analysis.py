...
from collapse.distribution_fit import FoldedDistributionFit, fit_folded_circular_models
from collapse.detector_resonance import DenseRingDetectorBuilder, DetectorSpec
