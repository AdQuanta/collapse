...
class DisentanglementVisualizer:
    ...
    :class:`~collapse.analysis.DisentanglementAnalyzer`.
...
class WrappedCauchyPlotter:
    ...
    :mod:`collapse.wrapped_cauchy`; this class handles only rendering.
    """
    ...
    def plot_comparison(
        ...
        """
        from collapse.wrapped_cauchy import compute_wrapped_sums, wrapped_cauchy_pdf
    ...
    def plot_ratio(
        ...
        tan²(θ/2).
        """
        from collapse.wrapped_cauchy import compute_wrapped_sums
...
class LevelSpacingPlotter:
    ...
    :mod:`collapse.level_spacing`; this class handles only rendering.
    """
    ...
    def plot_spacing_distribution(
        ...
        ax : matplotlib.axes.Axes or None
            ...
            figure.
        """
        from collapse.level_spacing import compute_unfolded_spacings
